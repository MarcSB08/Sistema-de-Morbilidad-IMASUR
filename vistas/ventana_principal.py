...
class VentanaPrincipal(ctk.CTkToplevel):
    def __init__(self, master_window):
        ...
        self.btn_eliminar = ctk.CTkButton(
            self.sidebar_frame,
            text="Eliminar Morbilidad",
            command=self.mostrar_eliminar,
        )
        self.btn_eliminar.grid(row=2, column=0, padx=20, pady=10)
        ...
        self.btn_relacion.grid(row=4, column=0, padx=20, pady=10)
        ...
        self.panel_eliminar = PanelEliminar(self.main_frame)
    ...
    def mostrar_ingreso(self):
        ...
        self.panel_eliminar.pack_forget()
    ...
    def mostrar_eliminar(self):
        ...
        self.panel_reportes.pack_forget()
        self.panel_relacion.pack_forget()
        self.panel_eliminar.pack(fill="both", expand=True)
